...
export default function LogoSymbol({
  ...
  return (
    ...
    >
      {/* tělo karty */}
      <rect fill="var(--tok-deep-plum, #2B1340)" x="2" y="2" width="116" height="164" rx="14" />
      {/* zlatý vnitřní rámeček */}
      <rect fill="none" stroke="var(--tok-soft-gold, #D4AF37)" x="10" y="10" width="100" height="148" rx="9" strokeWidth="2.5" />
      {/* hvězdička nahoře */}
      <path fill="var(--tok-soft-gold, #D4AF37)" d="M60 24 l2.8 6.4 6.4 2.8 -6.4 2.8 -2.8 6.4 -2.8 -6.4 -6.4 -2.8 6.4 -2.8 z" />
      ...
      />
      {/* hvězdička dole */}
      <path fill="var(--tok-soft-gold, #D4AF37)" d="M60 130 l2.2 5 5 2.2 -5 2.2 -2.2 5 -2.2 -5 -5 -2.2 5 -2.2 z" />
    </svg>
  );
}
