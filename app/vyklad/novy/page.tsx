  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 pb-20">
      ...
      {(step === "teaser" || step === "folie" || step === "paying" ||
        step === "payment_failed") && (
        <div className="py-10">
          {/* v1.6 §7.10 rámování. V OCHUTNÁVCE u VÍCEKARETNÍHO výkladu se
              otočí jen PRVNÍ karta (vždy normálně, obrácení až po platbě),
              zbytek zůstává rubem. U JEDNOKARETNÍHO výkladu (ano/ne) je ta
              jediná karta zároveň celý výklad - proto se lícem NEUKÁŽE,
              zůstává rubem až do zaplacení. */}
          ...
          <p className="mt-2 text-sm text-body-dim">
            {cards.length > 1
              ...
              : "Kartu jsem ti vytáhla. Otočí se ti v odemčeném výkladu."}
          </p>
