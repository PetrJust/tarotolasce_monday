      ...
      <div className="mt-6 rounded-2xl border border-accent-dim bg-surface p-6">
        ...
        <div className="mt-5 space-y-3">
          {PALETTE_TOKENS.map((t) => {
            ...
            // <input type=color> potřebuje platný #RRGGBB; když je uložená
            // hodnota rozepsaná (uživatel píše), dej pickeru platný fallback.
            const validHex = /^#[0-9a-fA-F]{6}$/.test(value) ? value : t.default;
            return (
